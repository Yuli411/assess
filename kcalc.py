...
def calculUtilityMultiplicative(myK, myU):
    if len(myK) - 1 == 2:
        return {'Ulatex':utilite2(myK[0]['value'], myK[1]['value'], myK[2]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute'])),'Uexcel':utilite2(myK[0]['value'], myK[1]['value'], myK[2]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute'])), 'U': utilite2(myK[0]['value'], myK[1]['value'], myK[2]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute'])), 'k': myK, 'utilities': myU}
    elif len(myK) - 1 == 3:
        return {'Ulatex':utilite3(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute']), convert_to_text_latex(myU[2], myK[2]['attribute'])),'Uexcel':utilite3(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute']), convert_to_text_excel(myU[2], myK[2]['attribute'])),'U': utilite3(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute']), convert_to_text(myU[2], myK[2]['attribute'])), 'k': myK, 'utilities': myU}
    elif len(myK) - 1 == 4:
        return {'Ulatex':utilite4(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute']), convert_to_text_latex(myU[2], myK[2]['attribute']), convert_to_text_latex(myU[3], myK[3]['attribute'])),'Uexcel':utilite4(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute']), convert_to_text_excel(myU[2], myK[2]['attribute']), convert_to_text_excel(myU[3], myK[3]['attribute'])), 'U': utilite4(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute']), convert_to_text(myU[2], myK[2]['attribute']), convert_to_text(myU[3], myK[3]['attribute'])), 'k': myK, 'utilities': myU}
    elif len(myK) - 1 == 5:
        return {'Ulatex':utilite5(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute']), convert_to_text_latex(myU[2], myK[2]['attribute']), convert_to_text_latex(myU[3], myK[3]['attribute']), convert_to_text_latex(myU[4], myK[4]['attribute'])),'Uexcel':utilite5(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute']), convert_to_text_excel(myU[2], myK[2]['attribute']), convert_to_text_excel(myU[3], myK[3]['attribute']), convert_to_text_excel(myU[4], myK[4]['attribute'])), 'U': utilite5(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute']), convert_to_text(myU[2], myK[2]['attribute']), convert_to_text(myU[3], myK[3]['attribute']), convert_to_text(myU[4], myK[4]['attribute'])), 'k': myK, 'utilities': myU}
    elif len(myK) - 1 == 6:
        return {'Ulatex':utilite6(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], myK[6]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute']), convert_to_text_latex(myU[2], myK[2]['attribute']), convert_to_text_latex(myU[3], myK[3]['attribute']), convert_to_text_latex(myU[4], myK[4]['attribute']), convert_to_text_latex(myU[5], myK[5]['attribute'])),'Uexcel':utilite6(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], myK[6]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute']), convert_to_text_excel(myU[2], myK[2]['attribute']), convert_to_text_excel(myU[3], myK[3]['attribute']), convert_to_text_excel(myU[4], myK[4]['attribute']), convert_to_text_excel(myU[5], myK[5]['attribute'])), 'U': utilite6(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], myK[5]['value'], myK[6]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute']), convert_to_text(myU[2], myK[2]['attribute']), convert_to_text(myU[3], myK[3]['attribute']), convert_to_text(myU[4], myK[4]['attribute']), convert_to_text(myU[5], myK[5]['attribute'])), 'k': myK, 'utilities': myU}
    U = 1
    return "Error : nothing was done"
    

def calculUtilityMultiQuali(myK, myU):
    if len(myK) - 1 == 2:
        return {'Ulatex':utilite2(myK[0]['value'], myK[1]['value'], myK[2]['value'], str(myU[0]), str(myU[1])),'Uexcel':utilite2(myK[0]['value'], myK[1]['value'], myK[2]['value'], str(myU[0]), str(myU[1])), 'U': utilite2(myK[0]['value'], myK[1]['value'], myK[2]['value'], str(myU[0]), str(myU[1])), 'k': myK, 'utilities': myU}
#    elif len(myK) - 1 == 3:
#        return {'Ulatex':utilite3(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute']), convert_to_text_latex(myU[2], myK[2]['attribute'])),'Uexcel':utilite3(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute']), convert_to_text_excel(myU[2], myK[2]['attribute'])),'U': utilite3(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute']), convert_to_text(myU[2], myK[2]['attribute'])), 'k': myK, 'utilities': myU}
#    elif len(myK) - 1 == 4:
#        return {'Ulatex':utilite4(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], convert_to_text_latex(myU[0], myK[0]['attribute']), convert_to_text_latex(myU[1], myK[1]['attribute']), convert_to_text_latex(myU[2], myK[2]['attribute']), convert_to_text_latex(myU[3], myK[3]['attribute'])),'Uexcel':utilite4(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], convert_to_text_excel(myU[0], myK[0]['attribute']), convert_to_text_excel(myU[1], myK[1]['attribute']), convert_to_text_excel(myU[2], myK[2]['attribute']), convert_to_text_excel(myU[3], myK[3]['attribute'])), 'U': utilite4(myK[0]['value'], myK[1]['value'], myK[2]['value'], myK[3]['value'], myK[4]['value'], convert_to_text(myU[0], myK[0]['attribute']), convert_to_text(myU[1], myK[1]['attribute']), convert_to_text(myU[2], myK[2]['attribute']), convert_to_text(myU[3], myK[3]['attribute'])), 'k': myK, 'utilities': myU}
...
def calculUtilityMultilinear(myK, myU):
    ...
    for monK in myK:
        ...
        for dk in monK['ID'].split(','):
            U += "*" + convert_to_text(myU[int(dk) - 1], myK[int(dk) - 1]['attribute'])
        U += "+"
